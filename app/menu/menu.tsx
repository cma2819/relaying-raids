  ...
  return (
    <Paper>
      <div className="flex flex-col w-full min-w-2xl">
        ...
        <MenuItem icon={<ListBulletIcon className="size-9" />} label="つくったリレーを確認する" description="リレーへの参加者登録、リレーの編集をします" href="/item-2" />
        <MenuItem icon={<FlagIcon className="size-9" />} label="リレーに参加する" description="登録済みのリレーに参加します" href="/item-3" />
      </div>
    </Paper>
  );
}